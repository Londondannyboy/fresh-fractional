    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="relative z-10 w-full py-20">
          <div className="max-w-6xl mx-auto px-6 lg:px-8">
            ...
            <div className="max-w-4xl">
              ...
              <p className="text-xl text-white/90 leading-relaxed max-w-2xl mb-8">Hire experienced finance professionals on a fractional basis. Get expert financial strategy, planning, and analysis without the cost of a full finance team.</p>
      ...
      <section id="contact" className="py-20 bg-gray-50 text-white">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-600 mb-10">Tell us about your financial needs and we'll match you with experienced finance professionals.</p>
