...
export const metadata: Metadata = {
  title: 'Part-Time CMO Jobs UK 2025',
  description: 'Part-time CMO jobs UK. Flexible CMO positions £700-£1,400/day. Remote & hybrid.',
  ...
  alternates: {
    canonical: 'https://fractional.quest/part-time-cmo-jobs-uk',
  },
  openGraph: {
    ...
    <div className="min-h-screen bg-white">
      ...
      <section id="jobs" className="py-16 md:py-20 bg-white">
        <div className="max-w-6xl mx-auto px-6 lg:px-8">
          ...
          <ServerJobGrid
            ...
            ctaText={`View All ${stats.total}+ CMO Jobs`}
            maxJobs={9}
            showViewAll={true}
          />
        </div>
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          ...
          <article className="prose prose-lg prose-gray max-w-none">
            ...
            <div className="bg-gray-50 text-gray-900 p-6 rounded-lg my-8 not-prose">
              <p className="text-gray-600 mb-3">Looking for fractional CMO positions instead?</p>
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          ...
          <div className="prose prose-lg prose-gray max-w-none">
            ...
            <div className="bg-gray-50 text-white p-6 rounded-lg my-8 not-prose">
              <p className="text-gray-600 mb-3">Browse remote CMO positions:</p>
      ...
      <section className="py-20 md:py-28 bg-gray-50 text-white">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-600 mb-10 max-w-2xl mx-auto">Create your profile and get matched with companies seeking part-time marketing leadership.</p>
