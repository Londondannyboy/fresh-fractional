    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          ...
          <p className="text-xl text-gray-600 leading-relaxed mb-6">A fractional agency provides ongoing access to agency-level talent and services on a part-time, retained basis. Instead of large monthly retainers for full agency services, you access the specific expertise you need at a fraction of the cost. Following <a href="https://ipa.co.uk" target="_blank" rel="noopener noreferrer" className="text-violet-600 hover:text-violet-700 underline">IPA best practices</a> and working within <a href="https://www.dandad.org" target="_blank" rel="noopener noreferrer" className="text-violet-600 hover:text-violet-700 underline">D&AD professional standards</a>, fractional agencies deliver world-class creative and strategic work at accessible budgets.</p>
          <p className="text-gray-600 mb-6">This model works particularly well for growing businesses that need strategic and creative support but don't have the budget for traditional agency relationships—or don't need the full breadth of agency services. As <a href="https://www.thinkbox.tv" target="_blank" rel="noopener noreferrer" className="text-violet-600 hover:text-violet-700 underline">Thinkbox research</a> demonstrates, effective marketing requires both strategic thinking and creative excellence—which fractional agencies provide without the overhead.</p>
        </div>
      </section>
