    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative min-h-[50vh] flex items-center overflow-hidden">
        <div className="absolute inset-0">
          <img src="https://images.pexels.com/photos/3184287/pexels-photo-3184287.jpeg?auto=compress&cs=tinysrgb&w=1920" alt="Fractional HR roles UK - human resources leadership team" className="w-full h-full object-cover" />
