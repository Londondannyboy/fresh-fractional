...
export default function FractionalRecruitmentPage() {
  const articleSchema = {
    ...
    '@type': 'Article',
    headline: 'Fractional Recruitment UK 2025: Specialist Executive Recruiters',
    description: 'Guide to fractional executive recruitment. Find specialist recruiters and platforms for part-time C-suite talent.',
    ...
    mainEntityOfPage: { '@type': 'WebPage', '@id': 'https://fractional.quest/fractional-recruitment' },
  }
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Recruitment', item: 'https://fractional.quest/fractional-recruitment' },
    ],
  }
