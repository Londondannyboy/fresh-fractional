...
export default function FractionalDirectorPage() {
  const articleSchema = {
    ...
    '@type': 'Article',
    headline: 'Fractional Director UK 2025: Complete Guide',
    description: 'Fractional director roles UK. Part-time director-level leadership across all business functions.',
    ...
    mainEntityOfPage: { '@type': 'WebPage', '@id': 'https://fractional.quest/fractional-director' },
  }
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Fractional Director', item: 'https://fractional.quest/fractional-director' },
    ],
  }
