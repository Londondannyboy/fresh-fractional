        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 max-w-4xl mx-auto">
            <p className="text-gray-700 leading-relaxed mb-4">
              Glasgow's economy is experiencing significant transformation. <a href="https://www.scottish-enterprise.com/support-for-businesses/develop-new-products-and-services/innovation-support/glasgow-city-innovation-district" target="_blank" rel="noopener noreferrer" className="text-purple-600 hover:text-purple-700 underline">Scottish Enterprise's Glasgow Innovation District</a> initiative has catalyzed growth in life sciences, fintech, and creative industries—all requiring fractional leadership to navigate expansion.
            </p>
            <p className="text-gray-700 leading-relaxed mb-4">
