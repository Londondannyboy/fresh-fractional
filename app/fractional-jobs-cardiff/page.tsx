        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 max-w-4xl mx-auto">
            <p className="text-gray-700 leading-relaxed mb-4">
              Cardiff's economy is growing rapidly as Wales' capital. <a href="https://businesswales.gov.wales/news-and-blog" target="_blank" rel="noopener noreferrer" className="text-purple-600 hover:text-purple-700 underline">Business Wales</a> reports significant expansion in professional services, media production, and fintech sectors, creating demand for fractional CFO, CMO, and operational leadership.
            </p>
            <p className="text-gray-700 leading-relaxed mb-4">
              The city's media and creative sector particularly drives opportunities. <a href="https://www.cardiffchamber.co.uk/insights/" target="_blank" rel="noopener noreferrer" className="text-purple-600 hover:text-purple-700 underline">Cardiff and Vale Chamber of Commerce</a> tracks growth in TV production, digital agencies, and tech startups—all requiring marketing and creative leadership.
            </p>
