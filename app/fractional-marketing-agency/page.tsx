...
export const metadata: Metadata = {
  title: 'Fractional Marketing Agency UK',
  description: 'Fractional marketing agency. Strategy, campaigns, execution. No full retainers.',
    ...
    <div className="min-h-screen bg-white">
      <section className="relative min-h-[60vh] flex items-center overflow-hidden">
        <div className="absolute inset-0">
          <img src="https://images.pexels.com/photos/7413891/pexels-photo-7413891.jpeg?auto=compress&cs=tinysrgb&w=1920" alt="Fractional marketing agency UK - marketing team planning campaign" className="w-full h-full object-cover" />
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          ...
          <p className="text-xl text-gray-600 leading-relaxed mb-6">A fractional marketing agency provides ongoing marketing strategy and execution on a part-time, retained basis. Instead of expensive full-service agency retainers, you get focused marketing support tailored to your specific needs and budget. Following <a href="https://www.cim.co.uk" target="_blank" rel="noopener noreferrer" className="text-amber-600 hover:text-amber-700 underline">CIM professional standards</a> and <a href="https://www.dma.org.uk" target="_blank" rel="noopener noreferrer" className="text-amber-600 hover:text-amber-700 underline">DMA best practices</a>, fractional marketing agencies deliver strategic, data-driven marketing excellence.</p>
          <p className="text-gray-600 mb-6">This model is perfect for growing businesses that need professional marketing but can't justify £15-30k monthly agency fees. You get senior marketing talent working as an extension of your team. As industry research consistently shows, strategic marketing leadership drives better ROI than tactical execution alone.</p>
        </div>
      </section>
      ...
      <section id="contact" className="py-20 bg-gray-50 text-white">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-600 mb-10">Tell us about your marketing needs and we'll match you with the right fractional marketing expertise.</p>
