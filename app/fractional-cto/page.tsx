        ...
        <div className="grid lg:grid-cols-4 gap-12">
          ...
          <main className="lg:col-span-3 space-y-12">
            ...
            <section id="guide" className="scroll-mt-24">
              <div className="mb-8 pb-4 border-b border-gray-100">
                <span className="text-xs font-bold uppercase tracking-[0.2em] text-blue-600 mb-2 block">Definition</span>
              ...
              <div className="bg-blue-50 border-l-4 border-blue-600 p-8 mb-12">
                <div className="prose prose-lg max-w-none">
                  <p className="text-xl md:text-2xl font-light text-gray-900 leading-relaxed mb-0">
            ...
            <section id="responsibilities" className="scroll-mt-24">
              <div className="mb-8 pb-4 border-b border-gray-100">
                <span className="text-xs font-bold uppercase tracking-[0.2em] text-blue-600 mb-2 block">Responsibilities</span>
            ...
            <section id="when-to-hire" className="scroll-mt-24">
              <div className="mb-8 pb-4 border-b border-gray-100">
                <span className="text-xs font-bold uppercase tracking-[0.2em] text-blue-600 mb-2 block">Timing</span>
            ...
            <section id="cost" className="scroll-mt-24">
              <div className="mb-8 pb-4 border-b border-gray-100">
                <span className="text-xs font-bold uppercase tracking-[0.2em] text-blue-600 mb-2 block">Pricing</span>
            ...
            <section id="benefits" className="scroll-mt-24">
              <div className="mb-8 pb-4 border-b border-gray-100">
                <span className="text-xs font-bold uppercase tracking-[0.2em] text-blue-600 mb-2 block">Benefits</span>
            ...
            <section id="comparison" className="scroll-mt-24">
              <div className="mb-8 pb-4 border-b border-gray-100">
                <span className="text-xs font-bold uppercase tracking-[0.2em] text-blue-600 mb-2 block">Comparison</span>
            ...
            <section id="how-to-hire" className="scroll-mt-24">
              <div className="mb-8 pb-4 border-b border-gray-100">
                <span className="text-xs font-bold uppercase tracking-[0.2em] text-blue-600 mb-2 block">Hiring Process</span>
            ...
            {/* Becoming Section */}
            <section id="becoming" className="scroll-mt-24">
              <div className="mb-8 pb-4 border-b border-gray-100">
                <span className="text-xs font-bold uppercase tracking-[0.2em] text-blue-600 mb-2 block">Career Path</span>
            ...
            <section id="faq" className="scroll-mt-24">
              <div className="mb-8 pb-4 border-b border-gray-100">
                <span className="text-xs font-bold uppercase tracking-[0.2em] text-blue-600 mb-2 block">FAQ</span>
                <h2 className="text-3xl md:text-4xl font-black text-gray-900">Frequently Asked Questions</h2>
              </div>
              <FAQ skipSchema={true} items={FRACTIONAL_CTO_FAQS} title="" />
            </section>

            {/* CTA */}
            <section className="bg-gray-900 rounded-2xl p-12 text-center text-white">
              <h2 className="text-3xl md:text-4xl font-black mb-6">Ready to Explore Fractional CTO Options?</h2>
              <p className="text-xl text-gray-300 mb-10 max-w-2xl mx-auto">
                Whether you're looking to hire a fractional CTO or become one, we have resources to help you succeed.
              </p>
              <div className="flex flex-wrap gap-4 justify-center">
                <Link href="/fractional-cto-services" className="px-8 py-4 bg-blue-500 text-white font-bold uppercase tracking-wider hover:bg-blue-400 transition-colors rounded-lg">
                  Hire a Fractional CTO
                </Link>
                <Link href="/fractional-cto-jobs-uk" className="px-8 py-4 border-2 border-white text-white font-bold uppercase tracking-wider hover:bg-white hover:text-black transition-colors rounded-lg">
                  Find CTO Jobs
                </Link>
                <Link href="/how-to-become-a-fractional-cto" className="px-8 py-4 border-2 border-white text-white font-bold uppercase tracking-wider hover:bg-white hover:text-black transition-colors rounded-lg">
          ...
          <aside className="lg:col-span-1 hidden lg:block">
            <div className="sticky top-24 space-y-8">
              <RoleSidebar role="cto" relatedRoles={['CIO', 'CISO', 'Product']} />
              
              {/* Mini CTA */}
              <div className="bg-gray-900 rounded-xl p-6 text-white text-center">
                <div className="text-3xl mb-2">💻</div>
                <h4 className="font-bold mb-2">Need Tech Leadership?</h4>
                <p className="text-sm text-gray-400 mb-4">We can match you with a vetted Fractional CTO in 48 hours.</p>
                <Link href="/contact" className="block w-full py-2 bg-blue-500 text-white font-bold rounded hover:bg-blue-600 text-sm transition-colors">
                  Get Matched
                </Link>
              </div>
            </div>
